...
//*****************************************************************************************  
&НаСервере
Процедура ПолучитьТекстФункцииПроцедуры()
...
Процедура ПроцедурыФункцииОбработкаВыбора(Элемент, ВыбранноеЗначение, ДополнительныеДанные, СтандартнаяОбработка)
	...
	ПолучитьТекстФункцииПроцедуры();   

	ЗагрузитьДанныеФункцииПроцедуры(ПроцедурыФункции, НЕ ЗначениеЗаполнено(Объект.Text)); 
