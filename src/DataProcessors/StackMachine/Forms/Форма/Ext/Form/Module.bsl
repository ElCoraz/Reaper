...
//	
//	ЧтениеТекста.Открыть(Объект.Файл);              
//	
//	Текст = ЧтениеТекста.Прочитать();
//	
//	ЧтениеТекста.Закрыть();

//	Данные = Decompile.ВыполнитьПарсинг(Текст);

//	Decompile.ОбработатьФайлНаСервере(Данные, Объект.Файл); 
//	
//	Decompile.ЗаполнитьЗначения();
